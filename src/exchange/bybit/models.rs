//! Bybit-specific data models for WebSocket communication.

use serde::{Deserialize, Serialize};

/// Bybit orderbook response structure (REST API)
...
/// WebSocket request message for Bybit
...
/// WebSocket response message from Bybit
#[derive(Debug, Deserialize)]
